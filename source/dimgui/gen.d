...
alias igListBoxHeaderInt_t0 = bool function(char* label, int items_count, int height_in_items);
...
alias igShowStyleEditor_t0 = void function(ImGuiStyle* ref_val);
...
alias igGetColorU32U32_t1 = ImU32 function(ImU32 col);
...
igListBoxHeaderInt_t0 igListBoxHeaderInt;
...
igGetColorU32U32_t1 igGetColorU32U32;
...
struct ImGuiIO {
    ...
    alias GetClipboardTextFn = char* function(void* user_data);
    alias SetClipboardTextFn = void function(void* user_data, char* text);
    void* ClipboardUserData;
    alias ImeSetInputScreenPosFn = void function(int x, int y);
...
bool load_imgui_lib(string shared_library) {
    ...
    igListBoxHeaderInt = bind!igListBoxHeaderInt_t0(handle, "igListBoxHeaderInt");
    ...
    igGetColorU32U32 = bind!igGetColorU32U32_t1(handle, "igGetColorU32U32");
